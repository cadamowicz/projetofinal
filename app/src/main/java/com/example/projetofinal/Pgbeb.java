...
public class Pgbeb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] listaBebidasValor=new String[listaBebidasBD.size()];
        ...
        for (int i=0; i < listaBebidasValor.length;i++) {
            listaBebidasValor[i] = listaBebidasBD.get(i).getValorBebidas() + ",00";
        ...
        spinnerBebida.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                for (int j=0; j < listaBebidasValor.length;j++) {
                    ...
                    if (op == j) {
                        bebidaSelecionada = listaBebidasValor[j];
